...
class Model(str, Enum):
    ...
    LLAMA3_2_3B = "gpt-4.1-mini"
    LLAMA3_1_8B = "gpt-4.1-mini"
    LLAMA3_3_70B = "gpt-4.1-mini"
    LLAMA3_2_90B_V = "gpt-4.1-mini"
    MIXTRAL = "gpt-4.1-mini"
    DEEPSEEK_V3 = "gpt-4.1-mini"
    DEEPSEEK_R1_DISTILL_QWEN_1_5B = "gpt-4.1-mini"
    GPT_4o = "gpt-4.1-mini"
